Contributing to BitcoinPay
============================

The BitcoinPay project operates an open contributor model where anyone is
...
The following applies to code changes to the bitcoinpay project, and is not to be
confused with overall bitcoinpay Network Protocol consensus changes.

Whether a pull request is merged into bitcoinpay rests with the project merge
...
Patches that change bitcoinpay consensus rules are considerably more involved than
...
Where a patch set proposes to change the bitcoinpay consensus, it must have been
...
The project leader is the release manager for each bitcoinpay release.
