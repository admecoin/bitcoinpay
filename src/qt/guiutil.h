...
/** Utility functions used by the bitcoinpay Qt UI.
 */
namespace GUIUtil
{
...
// Render bitcoinpay addresses in monospace font
...
// Parse "bitcoinpay:" URI into recipient object, return true on successful parsing
