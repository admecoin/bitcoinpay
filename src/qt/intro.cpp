...
static const uint64_t BLOCK_CHAIN_SIZE = 2LL * GB_BYTES; //M2: needs updating as chain progresses
...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BitcoinPay"),
     ...
     * override -datadir in the bitcoinpay.conf file in the default data directory
     * (to be consistent with bitcoinpayd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
