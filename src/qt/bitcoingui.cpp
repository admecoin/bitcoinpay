                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitcoinPay Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a bitcoinpay address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinpay: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitcoinPay Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinPay Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for bitcoinpay"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your bitcoinpay addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified bitcoinpay addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitcoinpay: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitcoinPay Core help message to get a list with possible bitcoinpay command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitcoinPay Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to bitcoinpay network", "", count));
}
...
{
    QString strTitle = tr("BitcoinPay Core"); // default title
