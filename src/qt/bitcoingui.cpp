                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BitcoinPay") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BitcoinPay"), this);
    aboutAction->setStatusTip(tr("Show information about BitcoinPay"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the BitcoinPay help message to get a list with possible bitcoinpay command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BitcoinPay client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("BitcoinPay"); // default title
