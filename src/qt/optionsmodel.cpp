...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::BPAY);
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in bitcoinpay.cpp during shotdown to also remove the window positions
...
bool OptionsModel::setData(const QModelIndex& index, const QVariant& value, int role)
{
    ...
    if (role == Qt::EditRole) {
        ...
        case AnonymizeBitcoinPayAmount:
            ...
            settings.setValue("nAnonymizeBitcoinPayAmount", nAnonymizeBitcoinPayAmount);
            emit anonymizeBitcoinPayAmountChanged(nAnonymizeBitcoinPayAmount);
            break;
        case CoinControlFeatures:
