/* src/config/bitcoinpay-config.h.  Generated from bitcoinpay-config.h.in by configure.  */
/* src/config/bitcoinpay-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BPAY_CONFIG_H

#define BPAY_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.bitcoinpay.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "BitcoinPay Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BitcoinPay Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoinpay"
