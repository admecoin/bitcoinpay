...
{
    //BitcoinPay will hash in the transaction hash and the index number in order to make sure each hash is unique
...
bool stakeTargetHit(uint256 hashProofOfStake, int64_t nValueIn, uint256 bnTargetPerCoinDay)
{
    ...
    uint256 bnCoinDayWeight = uint256(nValueIn) / 100; //m2: needs checking
