...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop bitcoinpay server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "bitcoinpay server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* bitcoinpay features */
        {"bitcoinpay", "masternode", &masternode, true, true, false},
        {"bitcoinpay", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinpay", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinpay", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinpay", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinpay", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinpay", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinpay", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinpay", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinpay", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinpay", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinpay", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinpay", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinpay", "mnbudget", &mnbudget, true, true, false},
        {"bitcoinpay", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinpay", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinpay", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinpay", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinpay", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinpay", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinpay", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinpay", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinpay", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinpay", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoinpay", "mnsync", &mnsync, true, true, false},
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitcoinpayd, or the -server option to bitcoinpay-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitcoinpay-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:12568/\n";
}
