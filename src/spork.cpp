...
bool IsSporkActive(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_POW_ENABLER) r = SPORK_17_POW_ENABLER_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_POW_ENABLER") return SPORK_17_POW_ENABLER;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_POW_ENABLER) return "SPORK_17_POW_ENABLER";
