...
This mechanism has been integrated into Bitcore-Node-bitcoinpay which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitcoinpay-Project/insight-api-bitcoinpay#web-socket-api](https://github.com/bitcoinpay-Project/insight-api-bitcoinpay#web-socket-api) 
* API: [https://github.com/bitcoinpay-Project/insight-api-bitcoinpay#swifttx-transactions](https://github.com/bitcoinpay-Project/insight-api-bitcoinpay#swifttx-transactions) 
...
By default, the BitcoinPay Core daemon will launch using the following constant:

```
static const int DEFAULT_RHENFAST_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitcoinPay Core daemon:
