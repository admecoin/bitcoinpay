...
In order to support loading of multiple wallets in bitcoinpay-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoinpay.cpp.
...
Changes to bitcoinpay.cpp
----------------------
bitcoinpay.cpp is the entry point into bitcoinpay-qt, and as such, will require some minor modifications to provide hooks for
