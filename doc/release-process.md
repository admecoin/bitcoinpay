...
### Build and sign BitcoinPay for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit bitcoinpay=v${VERSION} ../bitcoinpay/contrib/gitian-descriptors/gitian-win.yml
